...
"$SELF_DIR"/../_build/install/default/bin/add-grammar -c -r -g $2 $1 > "$SYGUS_WITH_GRAMMAR_FILE"

cvc4="$SELF_DIR"/../../CVC4/builds/bin/cvc4
...
#"$SELF_DIR"/../../CVC4/builds/bin/cvc4 --lang=sygus --no-checking --no-interactive --default-dag-thresh=0 "$SYGUS_WITH_GRAMMAR_FILE" | tail -n +2
